...
export const ADVICE_MODEL = "claude-sonnet-4-6";
...
- If data suggests something meaningfully abnormal (e.g. resting heart rate or HRV far outside the person's own baseline, irregular patterns, concerning symptoms described in chat), say so plainly and recommend they discuss it with a physician — but do not speculate about specific diagnoses or causes.
- Never tell someone to ignore concerning symptoms (chest pain, fainting, severe shortness of breath) in favor of waiting for more data — always recommend prompt medical attention for those.
...
- Keep daily advice concise — a few sentences to a short paragraph, not an essay.
